...
PRETRAINED_WEIGHTS: typing.Dict[str, typing.Any] = {
    "kurapan": {
        ...
        "weights": {
            "notop": {
                "url": "https://github.com/PearlClone/FinalProject_NSI/blob/root/crnn_kurapan_notop.h5",
                "filename": "crnn_kurapan_notop.h5",
                "sha256": "027fd2cced3cbea0c4f5894bb8e9e85bac04f11daf96b8fdcf1e4ee95dcf51b9",
            },
            "top": {
                "url": ".https://github.com/PearlClone/FinalProject_NSI/blob/root/crnn_kurapan.h5",
